...
export function renderWhatsAppCard(params: {
  ...
  return html`
    <div class="card">
      ...
      <div class="card-sub">${t("channels.whatsappSubtitle")}</div>
      ${accountCountLabel}
      ...
      ${
        props.whatsappQrDataUrl
          ? html`<div class="qr-wrap">
            <img src=${props.whatsappQrDataUrl} alt="WhatsApp 登录二维码" />
          </div>`
          : nothing
      }
      ...
      <div class="row" style="margin-top: 14px; flex-wrap: wrap;">
        ...
        >
          ${props.whatsappBusy ? t("common.loading") : t("channels.showQr")}
        </button>
        <button
          class="btn"
          ?disabled=${props.whatsappBusy}
