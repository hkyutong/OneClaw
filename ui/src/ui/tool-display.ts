...
const SLACK_SPEC: ToolDisplaySpec = {
  ...
  title: "Slack",
  actions: {
    react: { label: "添加回应", detailKeys: ["channelId", "messageId", "emoji"] },
    reactions: { label: "回应列表", detailKeys: ["channelId", "messageId"] },
    sendMessage: { label: "发送消息", detailKeys: ["to", "content"] },
    editMessage: { label: "编辑消息", detailKeys: ["channelId", "messageId"] },
    deleteMessage: { label: "删除消息", detailKeys: ["channelId", "messageId"] },
    readMessages: { label: "读取消息", detailKeys: ["channelId", "limit"] },
    pinMessage: { label: "置顶消息", detailKeys: ["channelId", "messageId"] },
    unpinMessage: { label: "取消置顶", detailKeys: ["channelId", "messageId"] },
    listPins: { label: "查看置顶", detailKeys: ["channelId"] },
    memberInfo: { label: "查看成员", detailKeys: ["userId"] },
    emojiList: { label: "表情列表" },
  },
};
