...
export const zh_CN: TranslationMap = {
  ...
  channels: {
    ...
    googleChatSubtitle: "Chat API Webhook 状态与频道配置。",
  ...
  nodes: {
    ...
    execBindingSubtitle: "当使用 exec host=node 时，将代理固定到指定节点。",
    switchToForm: "请先把 Config 页切换到表单模式，再在这里编辑绑定。",
  ...
  debug: {
    ...
    infoCount: "{count} 条提示",
    securityAuditHint: "如需更多细节，请运行 openclaw security audit --deep。",
    manualRpcTitle: "手动 RPC",
    manualRpcSubtitle: "直接发送原始网关方法与 JSON 参数。",
    method: "方法",
    selectMethod: "选择一个方法…",
    paramsJson: "参数（JSON）",
    call: "调用",
